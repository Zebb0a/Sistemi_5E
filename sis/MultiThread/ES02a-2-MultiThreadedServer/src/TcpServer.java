...
public class TcpServer {
    ...
    public static void main(String[] args) {
        try (ServerSocket serverSocket = new ServerSocket(PORT)) {
            System.out.println("Sono il Server sto attendendo un tuo segno sulla porta: " + PORT);

            while (true) {
                Socket clientSocket = serverSocket.accept();
                System.out.println("Bravo ti sei connesso con successo: " + clientSocket.getRemoteSocketAddress());
